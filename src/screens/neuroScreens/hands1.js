...
export default HandsScreen2 = ({navigation}) => {
  return (
    <View>
      <ScrollView
            ...
            <View style={styles.popularWrapper}>
                  <View
                          ...
                          <View style={[styles.flexRowTimer,{justifyContent: 'space-between'}]}> 
                            ...
                            <View style={[{borderWidth: 1, borderColor:colors.NA_L_blue, padding:7, backgroundColor:colors.NA_text_blue,  borderRadius: 13, overflow: "hidden",marginRight:15}]}>
                              <TouchableOpacity style={[{ alignSelf: 'center', backgroundColor:colors.NA_text_blue}]}
                                onPress={() => navigation.navigate('Hands3')}>
                    ...
                    <View style={styles.ImageWrapper}>
                      <Image source={{uri: 'https://s3-alpha-sig.figma.com/img/4f30/6cd7/efed91ab6d1a346176dd6c3b1da0b978?Expires=1653868800&Signature=XZPbRmIg5W1RfY6us~qJ--w-ZhDE~70KgiP7yj4WCd7EnkeSv309mJewFTrF9iMWweSl1YNc~mdRfBOvQb~JJa-MAiqwiu~fkwPwMWsiog87TS1FLvUrcfHHHkloD4Czs-Na5eE5ne7uagacrHdQej8pBetkOQNlGMwEtZLhSP9XoTvlTTqzTc9Yo4EeniezTPVt45A9Ou8bMetS4C2L9ulpKBgY9U~ffqlxpGCRz3JN72or-SBqMh5XfFPsvtpuo8X6qMUpf8K6oeiV2NGE6O1IiJWjhcVb1tKtcnq3HVD4~iRHcEtxSkOjfj0FSAqOYLUjy9A1Bg4gCw11esO-UA__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA'}}
                    ...
                    <View style={styles.flexRowTimer}>
                      ...
                      <Text style={styles.address}>2 sets of 6 reps, 3 times a day</Text>
                    </View>
